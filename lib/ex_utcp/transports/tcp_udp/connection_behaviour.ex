defmodule ExUtcp.Transports.TcpUdp.ConnectionBehaviour do
  ...
  @callback call_tool(conn :: pid(), tool_name :: String.t(), args :: map(), timeout :: integer()) :: {:ok, any()} | {:error, term()}
  @callback call_tool_stream(conn :: pid(), tool_name :: String.t(), args :: map(), timeout :: integer()) :: {:ok, Enumerable.t()} | {:error, term()}
